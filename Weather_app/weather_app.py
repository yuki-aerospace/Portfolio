...
I retrived informtion from openweathermap API.
'''
...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # Define labels
        self.location_label = tk.Label(self, text="City:" + "  " + self.city, font= ('Helvetica', 20), padx=10, pady=20)
        self.weather_label = tk.Label(self, text="Weather:" + "  " + self.weather, font= ('Helvetica', 20), padx=10, pady=20)
        self.temp_label = tk.Label(self, text="Temprature:" + "  " + str(self.temp)+  "  " + "°C", font= ('Helvetica', 20), padx=10, pady=20)
        self.humidity_label = tk.Label(self, text="Humidity:" + "  " + str(self.humidity)+  "  " + "%", font= ('Helvetica', 20), padx=10, pady=20)
        self.enter_label = tk.Label(self, text="ex) Los Angeles", font= ('Helvetica', 15), padx=10, fg="#3A3B3C")
